...
const Purchase = () => {
  ...
  const {
    ...
    fetch(`https://cycle-gear.onrender.com/product/${id}`).then((res) =>
      res.json()
    )
  );
  ...
  const onSubmit = (data) => {
    ...
    if (
      product.minimumOrderQuantity > quantity ||
      ...
      const error = (
        <p>
          ...
          <small className="text-red-600">
            You have to buy between {product.minimumOrderQuantity} to{" "}
            {product.productQuantity} products.{" "}
          </small>
        </p>
      );
      ...
      fetch(`https://cycle-gear.onrender.com/purchased`, {
        method: "POST",
        headers: {
      ...
      fetch(`https://cycle-gear.onrender.com/product/${id}`, {
        method: "PATCH",
        headers: {
          "content-type": "application/json",
        },
    ...
    <div className="bg-base-300 xl:h-full">
      <div className="md:flex m-4 lg:m-8">
        <div
          ...
          class="card lg:card-side bg-base-100 shadow-xl md:w-2/3 items-center justify-items-center m-4"
        >
          ...
          <div class="card-body sm:w-2/3">
            ...
            <h3 className="text-2xl">
              {" "}
              <span className="text-secondary font-semibold">Available:</span>
