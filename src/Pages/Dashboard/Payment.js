    ...
    return (
        <div className="mx-auto">
                <div class="card w-50 max-w-md bg-base-100 shadow-xl my-12">
                    <div class="card-body">
                        <h1 className='text-success text-2xl font-semibold'>Your Product Name: <span className="text-secondary font-bold">{payProduct.productName}</span></h1>
                        <h2 class="card-title">Please Pay  <span className="text-secondary"> ${payProduct.productPrice}</span> for <span className="text-secondary">{payProduct.quantity}</span>Pice </h2>
                    </div>
                    </div>
