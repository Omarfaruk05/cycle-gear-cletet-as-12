        ...
        <div className='bg-base-300 px-4 pt-4 '>
           <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                <div className='w-full mx-auto'>
                    ...
                    <h3 className='text-xl font-semibold '>Your Address: <span className='text-secondary'>{currentUser.address}</span></h3>
                ...
                <div className='bg-white rounded-lg shadow-lg p-4 w-full max-w-full mx-auto'>
                    <form onSubmit={handleSubmit(onSubmit)} className='grid grid-cols-1 gap-3 justify-items-center mt-2'>
                        ...
                        <textarea class="textarea textarea-bordered w-full max-w-md" {...register("address",{required: true})} placeholder="Address" name="address"></textarea>

                        <input type="number" name="phone" {...register("phone", {required: true})} placeholder="Phone Number" className="input input-bordered w-full max-w-md" />

                        <input type="text"  name="socialLink" {...register("socialLink", {required: true})} placeholder="Social Link" className="input input-bordered w-full max-w-md" />
