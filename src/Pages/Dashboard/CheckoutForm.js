...
const CheckoutForm = ({payProduct, stripePromise}) => {
        ...
        <>
            ...
            }
            {
                success && <div className='text-primary'>
                    <p>Status: <span className='text-secondary'>{success}</span></p>
                    <p className='text-primary'>Transection Id: <span className='text-secondary'>{transectionId}</span></p>
                </div>
            }
        </>
    );
