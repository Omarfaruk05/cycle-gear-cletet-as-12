        ...
        <div class="drawer drawer-end">
            ...
            <div class="drawer-content flex flex-col ">
                <div class="w-full navbar bg-slate-400 py-4 px-0 md:px-8 lg:px-16 ">
                    <label for="dashboard-sidebar" class="btn btn-square btn-ghost drawer-button lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-6 h-6 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
                    </label>
                    <div class="flex-1 text-3xl text-gray-700 font-semibold font-serif px-2 mx-2"><Link to="/">Cycle Gear</Link></div>
                    ...
                    <div class="flex-none hidden lg:block">
                        ...
                        {
                            user && <> <li><NavLink className='rounded-lg mx-2 text-white font-medium text-xl' to={"/dashboard"}>Dashboard</NavLink></li></>
                        }
            ...
            <div class="drawer-side">
                ...
                <li><NavLink className='rounded-lg mx-2' to={"/home"}>Home</NavLink></li>
                        ...
                        {
                            user && <><li><NavLink className='rounded-lg mx-2 font-medium' to={"/dashboard"}>Dashboard</NavLink></li></>
                        }
